...
/******************************************************************************************************************
POM: ToDoMainPage Vue
Page object to handle controls for create string checks

MODIFICATION LOG
29/11/2018					Initial Development					shraddha bhadauria
******************************************************************************************************************/
public class ToDoMainPageVue
{
	//Locators 
	private final String newStringValue = "//input[@type ='textbox']";
	//private final String delBtnLoc = "//button[@class = 'TaskDelete']";
	private final String cnclAppBtnFnlLoc = "//button[@class = 'TaskAdd']";

	WebDriver wdObj;
	public ToDoMainPageVue(WebDriver webDriverObj)
	{
